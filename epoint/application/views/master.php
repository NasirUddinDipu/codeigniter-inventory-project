...
<head>
        ...
        <link rel="icon" type="image/ico" href="<?php echo base_url(); ?>asset/images/fav.ico">
        <!--style sheet include-->
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/colorpicker.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/flexslider.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/owl.carousel.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/owl.transitions.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>asset/css/jquery.custom-scrollbar.css">
    ...
    <body>
            ...
            <header role="banner">
                        ...
                        <div class="row clearfix">
                            ...
                            <nav class="col-lg-4 col-md-4 col-sm-6 t_align_c t_xs_align_c">
                                <ul class="d_inline_b horizontal_list clearfix f_size_small users_nav">
                                    <li><a href="<?php echo base_url();?>" class="default_t_color">My Account</a></li>
                                    <li><a href="<?php echo base_url();?>welcome/wishlist" class="default_t_color">Wishlist</a></li>
                                    <li><a href="<?php echo base_url();?>welcome/checkout" class="default_t_color">Checkout</a></li>
                                    <li><a href="<?php echo base_url();?>welcome/contact" class="default_t_color">Contact Us</a></li>
                                </ul>
                            </nav>
                            <div class="col-lg-4 col-md-4 col-sm-3 t_align_r t_xs_align_c">
                                <ul class="horizontal_list clearfix d_inline_b t_align_l f_size_small site_settings type_2">
                                    <li class="container3d relative">
                                        <a role="button" href="#" class="color_dark" id="lang_button"><img class="d_inline_middle m_right_10" src="<?php echo base_url(); ?>asset/images/flag_en.jpg" alt="">English</a>
                                        <ul class="dropdown_list type_2 top_arrow color_light">
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo base_url(); ?>asset/images/flag_en.jpg" alt="">English</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo base_url(); ?>asset/images/flag_fr.jpg" alt="">French</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo base_url(); ?>asset/images/flag_g.jpg" alt="">German</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo base_url(); ?>asset/images/flag_i.jpg" alt="">Italian</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo base_url(); ?>asset/images/flag_s.jpg" alt="">Spanish</a></li>
                                        </ul>
                                    </li>
                ...
                <section class="h_bot_part container">
                    <div class="clearfix row">
                        <div class="col-lg-2 col-md-6 col-sm-4 t_xs_align_c">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-8">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-6 t_align_r t_xs_align_c m_xs_bottom_15">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 t_align_r t_xs_align_c m_xs_bottom_15">
                                            ...
                                            <div class="shopping_cart top_arrow tr_all_hover r_corners">
                                                ...
                                                <ul class="products_list">
                                                    <li>
                                                        <div class="clearfix">
                                                            <!--product image-->
                                                            <img class="f_left m_right_10" src="<?php echo base_url(); ?>asset/images/shopping_c_img_1.jpg" alt="">
                                                            <!--product description-->
                                                    ...
                                                    <li>
                                                        <div class="clearfix">
                                                            <!--product image-->
                                                            <img class="f_left m_right_10" src="<?php echo base_url(); ?>asset/images/shopping_c_img_2.jpg" alt="">
                                                            <!--product description-->
                                                            <div class="f_left product_description">
                                                                <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                                <span class="f_size_medium">Product Code PS34</span>
                                                    ...
                                                    <li>
                                                        <div class="clearfix">
                                                            <!--product image-->
                                                            <img class="f_left m_right_10" src="<?php echo base_url(); ?>asset/images/shopping_c_img_3.jpg" alt="">
                                                            <!--product description-->
                                                            <div class="f_left product_description">
                                                                <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                                <span class="f_size_medium">Product Code PS34</span>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
                        <div class="flexslider animate_ftr long">
                            <ul class="slides">
                                <li>
                                    <img src="<?php echo base_url(); ?>asset/images/slide_04.jpg" alt="" data-custom-thumb="<?php echo base_url(); ?>asset/images/slide_01.jpg">
                                ...
                                <li>
                                    <img src="<?php echo base_url(); ?>asset/images/slide_05.jpg" alt="" data-custom-thumb="<?php echo base_url(); ?>asset/images/slide_03.jpg">
                                ...
                                <li>
                                    <img src="<?php echo base_url(); ?>asset/images/slide_06.jpg" alt="" data-custom-thumb="<?php echo base_url(); ?>asset/images/slide_02.jpg">
                                    <section class="slide_caption_3 t_align_c d_xs_none">
                                        <img src="<?php echo base_url(); ?>asset/images/slider_layer_img.png" alt="" class="m_bottom_5">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 t_xs_align_c s_banners">
                        <a href="#" class="d_block d_xs_inline_b m_bottom_20 animate_ftr">
                            <img src="<?php echo base_url(); ?>asset/images/banner_img_7.jpg" alt="">
                        </a>
                        <a href="#" class="d_block d_xs_inline_b m_xs_left_5 animate_ftr m_mxs_left_0">
                            <img src="<?php echo base_url(); ?>asset/images/banner_img_8.jpg" alt="">
                        </a>
                    </div>
                    <?php
                    }
                            ...
                            <figure class="widget animate_ftr shadow r_corners wrapper m_bottom_30">
                                ...
                                <div class="widget_content">
                                    <div class="clearfix m_bottom_15 relative cw_product">
                                        <img src="<?php echo base_url(); ?>asset/images/bestsellers_img_1.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                                    ...
                                    <div class="clearfix m_bottom_25 relative cw_product">
                                        <img src="<?php echo base_url(); ?>asset/images/bestsellers_img_2.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                            ...
                            <figure class="widget animate_ftr shadow r_corners wrapper m_bottom_30">
                                ...
                                <div class="widget_content">
                                    ...
                                    <div class="clearfix m_bottom_5">
                                        <img src="<?php echo base_url(); ?>asset/images/bestsellers_img_3.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
        ...
        <div class="container">
            ...
            <div class="product_brands m_bottom_45 m_sm_bottom_35">
                <a href="#" class="d_block t_align_c animate_fade"><img src="<?php echo base_url()?>asset/images/brand_logo.jpg" alt=""></a>
                <a href="#" class="d_block t_align_c animate_fade"><img src="<?php echo base_url()?>asset/images/brand_logo.jpg" alt=""></a>
                <a href="#" class="d_block t_align_c animate_fade"><img src="<?php echo base_url()?>asset/images/brand_logo.jpg" alt=""></a>
                <a href="#" class="d_block t_align_c animate_fade"><img src="<?php echo base_url()?>asset/images/brand_logo.jpg" alt=""></a>
                <a href="#" class="d_block t_align_c animate_fade"><img src="<?php echo base_url()?>asset/images/brand_logo.jpg" alt=""></a>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 m_xs_bottom_30">
                            ...
                            <ul class="vertical_list">
                                ...
                                <li><a class="color_light tr_delay_hover" href="<?php echo base_url();?>welcome/manufacturers">Manufacturers<i class="fa fa-angle-right"></i></a></li>
                            </ul>
                        </div>
            ...
            <div class="footer_bottom_part">
                <div class="container clearfix t_mxs_align_c">
                    ...
                    <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                        <li><img src="<?php echo base_url(); ?>asset/images/payment_img_1.png" alt=""></li>
                        <li class="m_left_5"><img src="<?php echo base_url(); ?>asset/images/payment_img_2.png" alt=""></li>
                        <li class="m_left_5"><img src="<?php echo base_url(); ?>asset/images/payment_img_3.png" alt=""></li>
                        <li class="m_left_5"><img src="<?php echo base_url(); ?>asset/images/payment_img_4.png" alt=""></li>
                        <li class="m_left_5"><img src="<?php echo base_url(); ?>asset/images/payment_img_5.png" alt=""></li>
                    </ul>
                </div>
            </div>
            <?php
    ...
    <!--custom popup-->
                    ...
                    <div class="custom_scrollbar">
                        ...
                        <div class="f_left half_column">
                            <div class="relative d_inline_b m_bottom_10 qv_preview">
                                <span class="hot_stripe"><img src="<?php echo base_url(); ?>asset/images/sale_product.png" alt=""></span>
                                <img src="<?php echo base_url(); ?>asset/images/quick_view_img_1.jpg" class="tr_all_hover" alt="">
                            </div>
                            <!--carousel-->
                            <div class="relative qv_carousel_wrap m_bottom_20">
                                ...
                                <ul class="qv_carousel d_inline_middle">
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_1.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_2.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_3.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_6.jpg" alt=""></li>
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_1.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_2.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="<?php echo base_url(); ?>asset/images/quick_view_img_3.jpg"><img src="<?php echo base_url(); ?>asset/images/quick_view_img_6.jpg" alt=""></li>
                                </ul>
        ...
        <button class="t_align_c r_corners type_2 tr_all_hover animate_ftl" id="go_to_top"><i class="fa fa-angle-up"></i></button>
            <!--scripts include-->
            <script src="<?php echo base_url(); ?>asset/js/jquery-2.1.0.min.js"></script>
            ...
            <script src="<?php echo base_url(); ?>asset/js/styleswitcher.js"></script>
            <script src="<?php echo base_url(); ?>asset/js/colorpicker.js"></script>
            ...
            <script src="<?php echo base_url(); ?>asset/js/jquery.tweet.min.js"></script>
            <script src="<?php echo base_url(); ?>asset/js/jquery.custom-scrollbar.js"></script>
            <script src="<?php echo base_url(); ?>asset/js/scripts.js"></script>
            <script type="text/javascript" src="../../s7.addthis.com/<?php echo base_url(); ?>asset/js/300/addthis_widget.js#pubid=xa-5306f8f674bfda4c"></script>
    </body>
</html>