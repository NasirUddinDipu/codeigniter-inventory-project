        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="index.html"><span>ePoint Admin Panel</span></a>
                    ...
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/add_category"><i class="icon-plus"></i><span class="hidden-tablet"> Add Category</span></a></li>								
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/manage_category"><i class="icon-edit"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                                </ul>	
                            </li>
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-th-large"></i><span class="hidden-tablet">Manufacturer</span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/add_manufacturer"><i class="icon-plus"></i><span class="hidden-tablet">Add Manufacturer</span></a></li>								
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/manage_manufacturer"><i class="icon-edit"></i><span class="hidden-tablet">Manage Manufacturer</span></a></li>
                                </ul>	
                            </li>
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-th"></i><span class="hidden-tablet">Product</span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/add_product"><i class="icon-plus"></i><span class="hidden-tablet">Add Product</span></a></li>								
                                    <li><a class="submenu" href="<?php echo base_url(); ?>dashboard/manage_product"><i class="icon-edit"></i><span class="hidden-tablet">Manage Product</span></a></li>
                                </ul>	
                            </li>
                            <li><a href="index.html"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
